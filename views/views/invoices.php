        ...
        <div class="page-content"><!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
            ...
            <div id="invoice_info" style="display: none;">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="supplier" class="span6 m-wrap" style="margin: 0 auto;" data-provide="typeahead" data-items="4" 
                               data-source="[<?php echo Temp::autocomplete_data('traders'); ?>]">
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="row-fluid">
                        <form id="final_form">
                            ...
                            <div id="final_form_elements">
                                ...
                                <input class="hidden_input" type="hidden" name="supplier" />
